...
TEXTS = {
    "uz": {
        ...
        "send_link_hint": "🔗 Menga tekshirmoqchi bo'lgan havolangizni yuboring.\n\nMasalan: `example.com` yoki https://example.com\nQR-kod rasmi yoki APK fayl ham yuborsangiz bo'ladi.",
        "sub_required_after_trial": "✅ Siz {count} ta bepul tekshiruvdan foydalandingiz.\n\nDavom etish uchun kanalimizga a'zo bo'ling — bu bepul. Pastdagi tugma orqali qo'shiling va 'Tekshirish'ni bosing.",
...
"phish_alert": "🚨 *Ваш друг попался!* Пользователь только что кликнул по вашей тестовой фишинг-ссылке. Ему стоит быть внимательнее!",
        ...
        "send_link_hint": "🔗 Отправьте мне ссылку, которую нужно проверить.\n\nНапример: `example.com` или https://example.com\nТакже можно прислать фото QR-кода или APK-файл.",
        "sub_required_after_trial": "✅ Вы использовали {count} бесплатные проверки.\n\nЧтобы продолжить, подпишитесь на наш канал — это бесплатно. Вступите по кнопке ниже и нажмите 'Проверить'.",
    ...
    "en": {
        ...
        "send_link_hint": "🔗 Send me the link you want checked.\n\nFor example: `example.com` or https://example.com\nA QR code photo or an APK file works too.",
        "sub_required_after_trial": "✅ You have used your {count} free checks.\n\nTo keep going, join our channel — it is free. Use the button below, then tap 'Verify'.",
